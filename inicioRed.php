            ...
            <div class="carta-header">
                <div class="usuario-info">
                    ...
                    <div class="user-details">
                        ...
                        <div><?php echo $publicacion[5]; ?></div> <!-- Privacidad -->
                    </div>
                </div>
            </div>

            <div class="comentario">
                <p><?php echo $publicacion[2]; ?></p> <!-- Comentario -->
            </div>

            <div class="media-container">
                <?php
                $imagenes = explode(',', $publicacion[3]);
                $videos = explode(',', $publicacion[4]);
                ?>
